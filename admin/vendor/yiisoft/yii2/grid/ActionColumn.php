...
class ActionColumn extends Column
{
    ...
    protected function initDefaultButtons()
    {
		...
		$this->initDefaultButton('edit_banner', 'pencil');
        $this->initDefaultButton('edit_dt', 'pencil');
        $this->initDefaultButton('edit_cpzx', 'pencil');
        $this->initDefaultButton('edit_foot', 'pencil');
        $this->initDefaultButton('edit_ljwmsp', 'pencil');
        $this->initDefaultButton('edit_ppgs', 'pencil');
        $this->initDefaultButton('edit_ljwm', 'pencil');
        $this->initDefaultButton('edit_cpfl', 'pencil');
        $this->initDefaultButton('add_cp', 'plus');
        $this->initDefaultButton('edit_ps', 'pencil');
        $this->initDefaultButton('edit_xx', 'pencil');
        $this->initDefaultButton('edit_qydt', 'pencil');
        $this->initDefaultButton('edit_hyxw', 'pencil');
        $this->initDefaultButton('edit_index', 'pencil');
		$this->initDefaultButton('edit_img', 'pencil');
        
        $this->initDefaultButton('delete_id', 'trash', [
            'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
            'data-method' => 'post',
        ]);
        $this->initDefaultButton('delete_id_ps', 'trash', [
            'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
            'data-method' => 'post',
        ]);
        $this->initDefaultButton('delete_id_xx', 'trash', [
            'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
            'data-method' => 'post',
        ]);
        $this->initDefaultButton('delete_id_cpzx', 'trash', [
            'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
            'data-method' => 'post',
        ]);
		$this->initDefaultButton('delete_gcal', 'trash', [
            'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
            'data-method' => 'post',
        ]);
