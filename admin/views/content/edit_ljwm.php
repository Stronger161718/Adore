        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]) ?>
                    <img src="<?php echo Url::to('@web/uploads/'.$banner->img);?>" style="width:100%">
                    ...
                    <?= $form->field($text, 'text')->label('品牌定位'); ?>
                    <?= $form->field($text, 'content')->label('品牌愿景'); ?>
                    <?= Html::activeHiddenInput($text,'menu',array('value'=>'ljwm')) ?>
