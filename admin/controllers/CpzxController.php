...
{	
    ...
    public function actionCpfl()
    {
		...
		$model = new Cpfl();
        $query = Cpfl::find()->where(['isdel' =>'0','type'=>'1' ]);
    ...
    {
		Url::remember('', 'actions-redirect');
		$sql="select cpzx.* from cpfl,cpzx where cpzx.isdel='0' and cpfl.isdel='0' and cpfl.isrun='0' and cpfl.isdel='0' and cpfl.type='1' and cpzx.cpfl=cpfl.id;";
		$count = Yii::$app->db->createCommand("select count(*) from cpfl,cpzx where cpzx.isdel='0' and cpfl.isdel='0' and cpfl.isrun='0' and cpfl.isdel='0' and cpfl.type='1' and cpzx.cpfl=cpfl.id;")->queryScalar();
