...
<section class="row products">
	<div class="col-md-12 no-padding products-bg">
		<div class="col-md-6 no-padding products-bg-text">
			<p style="font-size:48px;font-style:italic;">PRODUCT</p>
			<br>
			<p style="font-size:48px;">产品中心</p>
		</div>
	</div>
	<a href="<?php echo base_url();?>index.php/welcome/cpzx/<?php echo $id;?>">
		<img src="<?php echo base_url();?>assets/images/products-left.png" style="position:absolute;z-index:1;">
		<div class="qingxie_left"><?php echo getcpfl()[$id]?></div>
	</a>
	...
	<div class="col-md-12 no-padding products-bgc">
		...
		<div class="col-md-2 no-padding pages">
			...
			<?php 
			if($page>1){
				echo base_url().'index.php/welcome/cpzx/'.$id.'/'.($page-1);
			}else{
				echo '';
			}
			?>
			...
			<a href="<?php 
			if($page>0){
				echo base_url().'index.php/welcome/cpzx/'.$id.'/'.$page;
			}else{
				echo '';
			}
			?>">
			...
			if($page>0 && $cpzx_count-$page>=2){
				echo base_url().'index.php/welcome/cpzx/'.$id.'/'.($page+2);
			}else{
				echo '';
			}
			?>">
		...
		<a href="<?php echo base_url().'index.php/welcome/cpzx/'.$ids;?>">
			...
			<div class="qingxie_right"><?php echo getcpfl()[$ids]?></div>
		</a>
	</div>
</section>
<footer class="footer">
