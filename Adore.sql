/*
 ...
 Source Host           : 188.131.183.148:3306
 Source Schema         : Adore
...
CREATE TABLE `content`  (
  ...
  `addtime` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `isrun` int(10) NOT NULL DEFAULT 0,
...
-- Records of content
-- ----------------------------
INSERT INTO `content` VALUES (1, 'logo', 'jcrop/1538166410.png', NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO `content` VALUES (2, 'banner', 'jcrop/1538164143.png', NULL, NULL, '11', NULL, 0, 1);
INSERT INTO `content` VALUES (3, 'banner', 'jcrop/1538168175.png', NULL, NULL, NULL, '1538168175', 0, 1);
INSERT INTO `content` VALUES (4, 'banner', 'jcrop/1540874968.jpg', NULL, NULL, 'http://www.ysweb1.top/index.php/welcome/details/11', '1540874968', 0, 0);
INSERT INTO `content` VALUES (5, 'banner', 'jcrop/1540875080.jpg', NULL, NULL, 'http://www.ysweb1.top/index.php/welcome/cpzx/1', '1540875081', 0, 0);
INSERT INTO `content` VALUES (6, 'banner', 'jcrop/1540875065.jpg', NULL, NULL, 'http://www.ysweb1.top/index.php/welcome/details/12', '1540875065', 0, 0);
INSERT INTO `content` VALUES (7, 'zxdt', 'jcrop/1540875171.jpg', NULL, NULL, '', '1540875172', 0, 0);
INSERT INTO `content` VALUES (8, 'zxdt', 'jcrop/1539857563.jpg', NULL, NULL, NULL, '1539857563', 0, 1);
INSERT INTO `content` VALUES (9, 'cpzx', 'jcrop/1540875376.jpg', '山地车是一种专门为越野行走而设计的自行车，1977年诞生于美国的旧金山。当时，一群年轻人萌生了这样的想法：“如果能骑着自行车从山顶上飞驰而下，一定是非常有趣的。”于是他们便开始着手尝试最早的越野自行车的设计，而正式命名为山地车则是在这之后两年的事情了。', '', 'http://www.ysweb1.top/index.php/welcome/cpzx/1', '1540875377', 0, 0);
INSERT INTO `content` VALUES (10, 'cpzx', 'jcrop/1540875250.jpg', '公路自行车，简称“公路车”。公路自行车、山地自行车及休闲自行车组成自行车类目的三大分类。在中国，公路自行车运动起步较晚，以山地自行车市场居于首位，不过随着公路自行车运动的普及，市场在不断扩大。', NULL, '', '1540875251', 0, 0);
INSERT INTO `content` VALUES (11, 'cpzx', 'jcrop/1540875412.jpg', '骑自行车对青少年的身体长高有一定的作用，自行车是一种有氧运动，通过腿部的运动，可以加速血液循环，刺激下肢骨的生长，有助于人体长高。', NULL, '', '1540875413', 0, 0);
INSERT INTO `content` VALUES (12, 'cpzx', 'jcrop/1540875431.jpg', '休闲顾名思义就是平常以锻炼身体为主，低强度不以竞赛为目的的骑行运动，可以是三五知己周末或者晚上约出来，沿着市区及周边骑车兜风，也可以是相约一起骑到一个地方去吃些美食，而且经常骑车可增进心肺功能改善心理健康。', NULL, '', '1540875432', 0, 0);
INSERT INTO `content` VALUES (18, 'zxdt', 'jcrop/1540875145.jpg', NULL, NULL, '', '1540875146', 0, 0);
INSERT INTO `content` VALUES (13, 'foot', 'jcrop/1539804948.jpg', '022-29513488', '天津市武清区庆通道6号', NULL, '1539804948', 0, 0);
INSERT INTO `content` VALUES (15, 'ljwmsp', 'jcrop/1541140177.jpg', '爱步品牌寓意爱上运动爱上骑行', NULL, NULL, '1541140177', 0, 0);
INSERT INTO `content` VALUES (16, 'ppgs', NULL, '随着空气质量日益引发公众的广泛关注，自行车又备受人们青睐,在“无烟出行”“绿色出行”等成为全世界时尚的当下，“爱步”自行车也将精彩绽放，我们尊崇：为客户创造价值，为社会创造效益的经营理念，凭借具有二十年行业经验的卓越团队，先进的进口设备，重新定位了“爱步”运动休闲自行车。倾力打造成国际品牌。  ', NULL, NULL, NULL, 0, 0);
INSERT INTO `content` VALUES (17, 'ljwm', 'jcrop/1541140218.jpg', '打造中国运动休闲自行车领导品牌', '为消费者提供卓越的产品和服务,成为锻炼、运动、出行新国货', NULL, '1541140220', 0, 0);
INSERT INTO `content` VALUES (19, 'banner', 'jcrop/1540875047.jpg', NULL, NULL, 'http://www.ysweb1.top/index.php/welcome/details/13', '1540875047', 0, 0);
INSERT INTO `content` VALUES (20, 'zxdt', 'jcrop/1540875116.jpg', NULL, NULL, '', '1540875117', 0, 0);

-- ----------------------------
-- Table structure for cpfl
-- ----------------------------
DROP TABLE IF EXISTS `cpfl`;
CREATE TABLE `cpfl`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `cpfl` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `img` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `type` enum('1','2') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '1' COMMENT '1产品中心2骑行装备',
  `isrun` enum('0','1','-1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  `isdel` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of cpfl
-- ----------------------------
INSERT INTO `cpfl` VALUES (1, '山地自行车', 'jcrop/1541075752.jpg', '1', '0', '0');
INSERT INTO `cpfl` VALUES (2, '公路自行车', 'jcrop/1540144919.jpg', '1', '-1', '1');
INSERT INTO `cpfl` VALUES (3, '旅行自行车', 'jcrop/1541075777.jpg', '1', '0', '0');
INSERT INTO `cpfl` VALUES (4, '青少年自行车', 'jcrop/1540144919.jpg', '1', '-1', '1');
INSERT INTO `cpfl` VALUES (5, '人身装备', 'jcrop/1540144919.jpg', '2', '-1', '0');
INSERT INTO `cpfl` VALUES (6, '车身装备', 'jcrop/1540144919.jpg', '2', '-1', '0');
INSERT INTO `cpfl` VALUES (7, '维修工具', 'jcrop/1540144919.jpg', '2', '-1', '0');

-- ----------------------------
-- Table structure for cpps
-- ----------------------------
DROP TABLE IF EXISTS `cpps`;
CREATE TABLE `cpps`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `mid` int(10) NOT NULL COMMENT '产品id',
  `img` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `isrun` enum('0','1','-1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  `isdel` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of cpps
-- ----------------------------
INSERT INTO `cpps` VALUES (1, 1, 'jcrop/1539724978.jpg', '0', '0');
INSERT INTO `cpps` VALUES (2, 1, 'jcrop/1539724585.jpg', '0', '1');
INSERT INTO `cpps` VALUES (3, 1, 'jcrop/1540007757.jpg', '0', '0');
INSERT INTO `cpps` VALUES (4, 11, 'jcrop/1540262991.jpg', '0', '1');
INSERT INTO `cpps` VALUES (5, 11, 'jcrop/1540263001.jpg', '0', '1');
INSERT INTO `cpps` VALUES (6, 11, 'jcrop/1540263011.jpg', '0', '1');
INSERT INTO `cpps` VALUES (7, 11, 'jcrop/1540263024.jpg', '0', '1');
INSERT INTO `cpps` VALUES (8, 11, 'jcrop/1540263035.jpg', '0', '1');
INSERT INTO `cpps` VALUES (9, 11, 'jcrop/1540263045.jpg', '0', '1');
INSERT INTO `cpps` VALUES (10, 11, NULL, '0', '1');
INSERT INTO `cpps` VALUES (11, 12, 'jcrop/1540263468.jpg', '0', '1');
INSERT INTO `cpps` VALUES (12, 12, 'jcrop/1540263491.jpg', '0', '1');
INSERT INTO `cpps` VALUES (13, 12, 'jcrop/1540263502.jpg', '0', '1');
INSERT INTO `cpps` VALUES (14, 12, 'jcrop/1540263512.jpg', '0', '1');
INSERT INTO `cpps` VALUES (15, 12, 'jcrop/1540263524.jpg', '0', '1');
INSERT INTO `cpps` VALUES (16, 12, 'jcrop/1540263525.jpg', '0', '1');
INSERT INTO `cpps` VALUES (17, 12, 'jcrop/1540263540.jpg', '0', '1');
INSERT INTO `cpps` VALUES (18, 13, 'jcrop/1540370618.jpg', '0', '1');
INSERT INTO `cpps` VALUES (19, 13, 'jcrop/1540370626.jpg', '0', '1');
INSERT INTO `cpps` VALUES (20, 13, 'jcrop/1540370656.jpg', '0', '1');
INSERT INTO `cpps` VALUES (21, 13, 'jcrop/1540370668.jpg', '0', '1');
INSERT INTO `cpps` VALUES (22, 14, 'jcrop/1540814699.jpg', '0', '0');
INSERT INTO `cpps` VALUES (23, 11, 'jcrop/1540958549.jpg', '0', '0');
INSERT INTO `cpps` VALUES (24, 11, 'jcrop/1540958597.jpg', '0', '0');
INSERT INTO `cpps` VALUES (25, 11, 'jcrop/1540958612.jpg', '0', '0');
INSERT INTO `cpps` VALUES (26, 11, 'jcrop/1540958625.jpg', '0', '0');
INSERT INTO `cpps` VALUES (27, 11, 'jcrop/1540958638.jpg', '0', '0');
INSERT INTO `cpps` VALUES (28, 11, 'jcrop/1540958652.jpg', '0', '0');
INSERT INTO `cpps` VALUES (29, 11, NULL, '0', '1');
INSERT INTO `cpps` VALUES (30, 11, NULL, '0', '1');
INSERT INTO `cpps` VALUES (31, 11, NULL, '0', '1');
INSERT INTO `cpps` VALUES (32, 12, 'jcrop/1540960880.jpg', '0', '0');
INSERT INTO `cpps` VALUES (33, 12, 'jcrop/1540960890.jpg', '0', '0');
INSERT INTO `cpps` VALUES (34, 12, 'jcrop/1540960907.jpg', '0', '0');
INSERT INTO `cpps` VALUES (35, 12, 'jcrop/1540960920.jpg', '0', '0');
INSERT INTO `cpps` VALUES (36, 12, 'jcrop/1540960929.jpg', '0', '0');
INSERT INTO `cpps` VALUES (37, 12, 'jcrop/1540960941.jpg', '0', '0');
INSERT INTO `cpps` VALUES (38, 13, 'jcrop/1540960993.jpg', '0', '0');
INSERT INTO `cpps` VALUES (39, 13, 'jcrop/1540961001.jpg', '0', '0');
INSERT INTO `cpps` VALUES (40, 13, 'jcrop/1540961010.jpg', '0', '0');
INSERT INTO `cpps` VALUES (41, 13, 'jcrop/1540961018.jpg', '0', '0');

-- ----------------------------
-- Table structure for cpxx
-- ----------------------------
DROP TABLE IF EXISTS `cpxx`;
CREATE TABLE `cpxx`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `mid` int(11) NOT NULL COMMENT '对应产品',
  `cpcc` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '产品尺寸',
  `cpjg` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '产品价格',
  `isrun` enum('0','1','-1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  `isdel` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of cpxx
-- ----------------------------
INSERT INTO `cpxx` VALUES (1, 1, '26', '1298', '0', '0');
INSERT INTO `cpxx` VALUES (2, 1, '25', '1499', '0', '0');
INSERT INTO `cpxx` VALUES (3, 11, '26\'\'', '1298', '0', '0');
INSERT INTO `cpxx` VALUES (4, 12, '26\'\'', '1398', '0', '0');

-- ----------------------------
-- Table structure for cpzx
-- ----------------------------
DROP TABLE IF EXISTS `cpzx`;
CREATE TABLE `cpzx`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `cpmc` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '产品名称',
  `cpfl` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '产品分类',
  `img` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `cpmsimg` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `cpms` text CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT '产品描述',
  `isrun` enum('0','1','-1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  `isdel` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of cpzx
-- ----------------------------
INSERT INTO `cpzx` VALUES (1, '前行者D660', '1', 'jcrop/1540007622.jpg', NULL, NULL, '0', '1');
INSERT INTO `cpzx` VALUES (2, '前行者D660', '1', 'jcrop/1539722611.jpg', NULL, NULL, '0', '1');
INSERT INTO `cpzx` VALUES (3, '前行着550', '1', 'jcrop/1539722611.jpg', NULL, NULL, '0', '1');
INSERT INTO `cpzx` VALUES (4, '前行者D660', '1', 'jcrop/1539722611.jpg', NULL, NULL, '0', '1');
INSERT INTO `cpzx` VALUES (5, '前行者D660', '1', 'jcrop/1539722611.jpg', NULL, NULL, '0', '1');
INSERT INTO `cpzx` VALUES (6, '前行者D660', '1', 'jcrop/1539722611.jpg', NULL, NULL, '0', '1');
INSERT INTO `cpzx` VALUES (7, '前行者D660', '1', 'jcrop/1539722611.jpg', NULL, NULL, '0', '1');
INSERT INTO `cpzx` VALUES (8, '前行者D660', '1', 'jcrop/1539722611.jpg', NULL, NULL, '0', '1');
INSERT INTO `cpzx` VALUES (9, '前行者D660', '1', 'jcrop/1539722611.jpg', NULL, NULL, '0', '1');
INSERT INTO `cpzx` VALUES (11, '前行者550', '1', 'jcrop/1540957255.jpg', NULL, 'a:7:{i:0;s:33:\"20181031/15409584421854152879.jpg\";i:1;s:33:\"20181031/15409584421752235872.jpg\";i:2;s:32:\"20181031/1540958442689789436.jpg\";i:3;s:32:\"20181031/1540958442777150985.jpg\";i:4;s:33:\"20181031/15409584421829951694.jpg\";i:5;s:32:\"20181031/1540958442600704760.jpg\";i:6;s:33:\"20181031/15409584421890370745.jpg\";}', '0', '0');
INSERT INTO `cpzx` VALUES (12, '前行者D660', '1', 'jcrop/1540958867.jpg', NULL, 'a:10:{i:0;s:33:\"20181031/15409584632056393254.jpg\";i:1;s:33:\"20181031/15409584631273496199.jpg\";i:2;s:33:\"20181031/15409584631757766423.jpg\";i:3;s:31:\"20181031/154095846376090082.jpg\";i:4;s:32:\"20181031/1540958463874546521.jpg\";i:5;s:32:\"20181031/1540958463196022438.jpg\";i:6;s:33:\"20181031/15409584631839510211.jpg\";i:7;s:32:\"20181031/1540958463518345719.jpg\";i:8;s:33:\"20181031/15409584631804064521.jpg\";i:9;s:33:\"20181031/15409584631727559147.jpg\";}', '0', '0');
INSERT INTO `cpzx` VALUES (14, '测试', '5', 'jcrop/1540309436.jpg', 'uploads/20181023/1540309454.jpg', 'a:2:{i:0;O:20:\"yii\\web\\UploadedFile\":5:{s:4:\"name\";s:5:\"4.JPG\";s:8:\"tempName\";s:24:\"/data/home/tmp/phpkTW2TY\";s:4:\"type\";s:10:\"image/jpeg\";s:4:\"size\";i:1152818;s:5:\"error\";i:0;}i:1;O:20:\"yii\\web\\UploadedFile\":5:{s:4:\"name\";s:5:\"5.JPG\";s:8:\"tempName\";s:24:\"/data/home/tmp/phpblnFI4\";s:4:\"type\";s:10:\"image/jpeg\";s:4:\"size\";i:1062562;s:5:\"error\";i:0;}}', '-1', '0');
INSERT INTO `cpzx` VALUES (13, '探索者', '3', 'jcrop/1540960972.jpg', NULL, 'a:8:{i:0;s:33:\"20181031/15409610521838925033.jpg\";i:1;s:33:\"20181031/15409610521735606351.jpg\";i:2;s:33:\"20181031/15409610521663341979.jpg\";i:3;s:32:\"20181031/1540961052324173267.jpg\";i:4;s:32:\"20181031/1540961052984124665.jpg\";i:5;s:33:\"20181031/15409610521598589646.jpg\";i:6;s:33:\"20181031/15409610521602557538.jpg\";i:7;s:33:\"20181031/15409610521605732701.jpg\";}', '0', '0');
...
CREATE TABLE `join`  (
  ...
  `sex` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0' COMMENT '0男1女',
  `xl` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `phone` varchar(11) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `tel` varchar(12) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `yb` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `email` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `qw` varchar(12) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `lxdz` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `qd` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `sytz` enum('0','1','2') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `sf` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `sq` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `xq` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `qt` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `xdmd` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `hyjy` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `zwfx` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `dplx` enum('0','1','2') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  `ly` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `isread` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `migration` VALUES ('m000000_000000_base', 1527787472);
INSERT INTO `migration` VALUES ('m140209_132017_init', 1527787481);
INSERT INTO `migration` VALUES ('m140403_174025_create_account_table', 1527787482);
INSERT INTO `migration` VALUES ('m140504_113157_update_tables', 1527787486);
INSERT INTO `migration` VALUES ('m140504_130429_create_token_table', 1527787487);
INSERT INTO `migration` VALUES ('m140830_171933_fix_ip_field', 1527787488);
INSERT INTO `migration` VALUES ('m140830_172703_change_account_table_name', 1527787488);
INSERT INTO `migration` VALUES ('m141222_110026_update_ip_field', 1527787489);
INSERT INTO `migration` VALUES ('m141222_135246_alter_username_length', 1527787490);
INSERT INTO `migration` VALUES ('m150614_103145_update_social_account_table', 1527787492);
INSERT INTO `migration` VALUES ('m150623_212711_fix_username_notnull', 1527787493);
INSERT INTO `migration` VALUES ('m151218_234654_add_timezone_to_profile', 1527787493);
INSERT INTO `migration` VALUES ('m160929_103127_add_last_login_at_to_user_table', 1527787494);
...
CREATE TABLE `news`  (
  ...
  `img` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `js` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `content` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `type` enum('1','2') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '1' COMMENT '1企业动态2行业新闻',
  `date` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `isrun` enum('1','0','-1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  `isdel` enum('0','1') CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of news
-- ----------------------------
INSERT INTO `news` VALUES (1, '1', NULL, NULL, '1', '1', '1', '0', '1');
INSERT INTO `news` VALUES (2, '标题1111111111', NULL, NULL, '<p>今天2333333333<br/></p>', '1', '1', '0', '1');
INSERT INTO `news` VALUES (3, '标题1111111', 'jcrop/1539858022.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p><p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p><p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '1', '1539820800', '0', '1');
INSERT INTO `news` VALUES (4, '标题22222222', NULL, NULL, '123', '1', '1539734400', '0', '1');
INSERT INTO `news` VALUES (5, '标题333333333', 'jcrop/1539858548.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '2', '1539734400', '0', '1');
INSERT INTO `news` VALUES (6, '测试', NULL, NULL, '<p>测试的内容测试的内容测试的内容测试的内容测试的内容</p>', '1', '1539561600', '0', '1');
INSERT INTO `news` VALUES (7, '北京青年报：为北京规范电动自行车管理点赞', 'jcrop/1539858100.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '1', '1539907200', '0', '1');
INSERT INTO `news` VALUES (16, '测试', 'jcrop/1541147237.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '1', '1541088000', '0', '1');
INSERT INTO `news` VALUES (8, '北京青年报：为北京规范电动自行车管理点赞', 'jcrop/1539858118.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p><p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '1', '1539907200', '0', '1');
INSERT INTO `news` VALUES (9, '北京青年报：为北京规范电动自行车管理点赞', NULL, '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p style=\"text-indent: 2em;\">采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p><p style=\"text-indent: 2em;\">采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p><p style=\"text-indent: 2em;\">采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p><p style=\"text-indent: 2em;\">采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '1', '1539993600', '0', '1');
INSERT INTO `news` VALUES (10, '北京青年报：为北京规范电动自行车管理点赞', 'jcrop/1539858145.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。<br/></p>', '1', '1539820800', '0', '1');
INSERT INTO `news` VALUES (11, '北京青年报：为北京规范电动自行车管理点赞', 'jcrop/1539858512.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。<br/></p>', '1', '1539475200', '0', '1');
INSERT INTO `news` VALUES (12, '北京青年报：为北京规范电动自行车管理点赞', 'jcrop/1539858568.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '1', '1538611200', '0', '1');
INSERT INTO `news` VALUES (13, '北京青年报：为北京规范电动自行车管理点赞', 'jcrop/1539858688.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '1', '1539820800', '0', '1');
INSERT INTO `news` VALUES (14, '北京青年报：为北京规范电动自行车管理点赞', 'jcrop/1539858816.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '2', '1539820800', '0', '1');
INSERT INTO `news` VALUES (15, '北京青年报：为北京规范电动自行车管理点赞', 'jcrop/1539858895.jpg', '采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。', '<p>采取“快中有慢”的过渡期政策，照顾到了群众的现实需求，3年时限与电动自行车使用寿命相结合，降低了可能造成的经济损失。在电动自行车治理过程中，施行过渡期政策有利于获得最广泛的支持，有利于治理工作取得最终成功。</p>', '2', '1539820800', '0', '1');
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 'MoX_56FxEMP5UyrMwTpGLNXRhSykFZM6', 1527795056, 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'admin@admin.com', '$2y$12$z7JQ3EvlGOTG6D3n48D01u9H4D4wKqC3MPizzWWzStAOtkEKspUpK', 'Cbak6EHsfVl6SPK2VVLTu_kshBFhWLX0', NULL, NULL, NULL, '::1', 1527795056, 1528795003, 0, 1541169179, 0);

-- ----------------------------
-- Table structure for xwss_img
-- ----------------------------
DROP TABLE IF EXISTS `xwss_img`;
CREATE TABLE `xwss_img`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `type` enum('0','1') CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT NULL,
  `img` varchar(255) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of xwss_img
-- ----------------------------
INSERT INTO `xwss_img` VALUES (1, '0', 'jcrop/1540961526.jpg');
INSERT INTO `xwss_img` VALUES (2, '1', 'jcrop/1540961692.jpg');

-- ----------------------------
-- Table structure for zsjm
-- ----------------------------
DROP TABLE IF EXISTS `zsjm`;
CREATE TABLE `zsjm`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `dpmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '店铺名称',
  `sf` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '省份',
  `sq` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '市区',
  `xq` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '县区',
  `xxdz` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '详细地址',
...
-- Records of zsjm
-- ----------------------------
INSERT INTO `zsjm` VALUES (2, '旗舰店', '120000', '120100', '120111', 'XX号', '022-0000000', '0', '0');
